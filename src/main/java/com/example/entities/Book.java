...
/**
 * Represents a literary work or library asset within the system inventory.
 * 
 * <p>This entity manages core book metadata (ISBN, Title, Author) and tracks real-time 
 * availability through its quantity and issued-to properties.</p>
 * 
 * <p>Key Features:
 * <ul>
 *   <li><b>State Validation:</b> Enforces integrity of ISBN formats and prevents negative 
 *       inventory levels or pricing.</li>
 *   <li><b>Availability Tracking:</b> Provides helper methods to determine the current 
 *       circulaton status of a book.</li>
 *   <li><b>Timestamping:</b> Automatically tracks creation and modification dates.</li>
 * </ul>
 * 
